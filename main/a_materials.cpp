...
void cook_torrance_prep(Material** materials) {
    materials[0] = new LambertianMaterial(blacktex, whitetex);
    materials[1] = new LambertianMaterial(blacktex, redtex);
    materials[2] = new LambertianMaterial(blacktex, greentex);

    materials[3] = new CookTorranceMaterial(whitetex, 0.6f, 15.0f, 0.4f);
...
void a_materials() {
    ...
    cook_torrance_prep(materials);
    a7renderCornellbox(0.001f, "a6-1dbonus-cook_torrance.png", materials);
    std::cout << "Done cook\n";
    delete [] materials;
}
